...
def preprocess_and_save_images(input_folder, output_folder, img_size=(48, 48), color_mode='grayscale', invert=True):
...
preprocess_and_save_images('raw_data/ticks', 'data/ticks', img_size=(48, 48), color_mode='grayscale', invert=True)
preprocess_and_save_images('raw_data/half_ticks', 'data/half_ticks', img_size=(48, 48), color_mode='grayscale', invert=True)
...
neither_images, neither_labels = load_images_from_folder('data/neither', 2)

X = np.concatenate([ticks_images, half_ticks_images, neither_images], axis=0)
y = np.concatenate([ticks_labels, half_ticks_labels, neither_labels], axis=0)
